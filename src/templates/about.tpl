...
<div class="content">
	...
	<div class="attention"><div class="emphasis">Your Conversations, <br />Your Cloud!</div></div>
	...
	<div class="details section">
		<div class="row">
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Discussion topics</b> - like social networks that you are likely familiar with.</li>
					<li><b>Direct messaging</b> - like texting on your phone.</li>
			...
			<div class="col-sm-6">
				...
				<ul>
					<li><b>Engage</b> in topic-oriented discussions with multiple participants. </li>
					<li>Have <b>personal</b>, private one-on-one discussions. </li>
